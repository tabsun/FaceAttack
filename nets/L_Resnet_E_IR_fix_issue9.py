...
def get_resnet_fi9(inputs, num_layers, scope=None, type=None, w_init=None, trainable=None, sess=None, reuse=False, keep_rate=None):
    if type == 'ir':
    ...
    # I modify 256 to 1024 in block3
    if num_layers == 50:
        blocks = [
            ...
            resnetse_v1_block('block3', base_depth=256, num_units=7, stride=2, rate=1, unit_fn=unit_fn),
...
if __name__ == '__main__':
        ...
        # test resnetse
        nets = get_resnet_d(x, 50, type='ir', w_init=w_init, sess=sess)
