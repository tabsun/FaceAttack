...
def get_spherefacenet(input,embedding_size=1024, scope=None):
...
if __name__ == '__main__':
    ...
    embedding = get_spherefacenet(x, scope='sphereface')

    sess = tf.Session()
    saver = tf.train.Saver()
    saver.restore(sess, '../models/sphereface/model-20180626-205832.ckpt')
